...
class RaceEvent
{
    ...
    private long time;
    public RaceEvent(long time) { this.time = time; }
    public RaceEvent(long time, int winner) { this(time); this.winner = winner; }
...
class JRace extends JPanel implements ActionListener, MouseListener
{
    private static class Runner
    {
        ...
        public Rectangle getColl(int x, int y, int width, int height){
